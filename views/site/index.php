            ...
            <div class="rev_slider_wrapper">
                <div class="rev_slider" data-version="5.0">
                    <ul>
                        ...
                        <!-- SLIDE 1 -->
                        <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg11.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg11.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                            <!-- LAYERS -->
...
<!--                            <div class="tp-caption tp-resizeme text-center text-white font-raleway bg-dark-transparent pl-30 pr-30 border-theme-colored" 
                        ...
                        <!-- SLIDE 2 -->
                        <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg12.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg12.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption tp-resizeme text-center text-white font-raleway bg-dark-transparent pl-30 pr-30 border-theme-colored" 
                                 ...
                                 data-splitout="none" 
                                 data-responsive_offset="on"
                                 style="z-index: 5; white-space: nowrap; font-weight:600; border-right: 6px solid;">Torneo Nacional
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme text-center text-white font-raleway bg-dark-transparent pl-30 pr-30 border-theme-colored" 
                                 ...
                                 data-splitout="none" 
                                 data-responsive_offset="on"
                                 style="z-index: 5; white-space: nowrap; font-weight:600; border-right: 6px solid;">Instalaciones colegio Francisco
                            </div>
                        </li>
                    </ul>
                </div><!-- end .rev_slider -->
    ...
    <!-- Section: About --><section id="about" class="bg-lighter">
        <div class="container pb-70">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/about/1.jpg" alt=""> </div>
                    <div class="col-md-6">
                        <div class="events-venue border-theme-colored border-5px p-40 pt-0 mt-50 ml-sm-0 mt-sm-0 mt-xs-0 pt-sm-80" data-margin-left="-60px">
                            <h2 class="events-trainer-title text-uppercase letter-space-1 text-center text-theme-colored bg-lighter mb-20">We the trainers</h2>
                            <div class="pl-50 pl-sm-0 mb-20 mt-40">
                ...
                <div class="row">
                        ...
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/1.jpg" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 mb-30">
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/2.jpg" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 mb-30">
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/3.jpg" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 mb-30">
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/4.jpg" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 mb-30">
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/5.jpg" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 mb-30">
                        <div class="card effect__hover">
                            <div class="card__front bg-theme-colored">
                                <div class="card__text">
                                    <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/achievements/6.jpg" alt="">
    ...
    <!-- Section: Video -->
    <section class="divider parallax layer-overlay overlay-dark"  data-bg-img="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg8.jpg" >
        <div class="display-table">
            <div class="display-table-cell">
                <div class="container">
                    <div class="row">
    ...
    <!-- Section: Services -->
    <section id="services" data-bg-img="<?= Yii::$app->request->baseUrl; ?>/images/pattern/p8.png">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="class-item box-hover-effect effect1 mb-sm-30">
                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="<?= Yii::$app->request->baseUrl; ?>/images/services/1.jpg" alt="..."></a> </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="class-item box-hover-effect effect1 mb-sm-30">
                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="<?= Yii::$app->request->baseUrl; ?>/images/services/2.jpg" alt="..."></a> </div>
                            <div class="caption"> <span class="text-uppercase letter-space-1 mb-10 font-12 text-gray-silver">ipsum fugit </span>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="class-item box-hover-effect effect1 mb-sm-30">
                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="<?= Yii::$app->request->baseUrl; ?>/images/services/3.jpg" alt="..."></a> </div>
                            <div class="caption"> <span class="text-uppercase letter-space-1 mb-10 font-12 text-gray-silver">ipsum fugit </span>
                        ...
                        <div class="training-classes-carousel owl-carousel-3col" data-dots="true">
                            <div class="item">
                                <div class="trainer-item style2">
                                    <div class="trainer-thumb"> <img src="<?= Yii::$app->request->baseUrl; ?>/images/team/1.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                            ...
                            <div class="item">
                                <div class="trainer-item style2">
                                    <div class="trainer-thumb"> <img src="<?= Yii::$app->request->baseUrl; ?>/images/team/2.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                                    <div class="trainer-info pb-30">
                                        <div class="trainer-biography">
                            ...
                            <div class="item">
                                <div class="trainer-item style2">
                                    <div class="trainer-thumb"> <img src="<?= Yii::$app->request->baseUrl; ?>/images/team/3.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                                    <div class="trainer-info pb-30">
                                        <div class="trainer-biography">
                            ...
                            <div class="item">
                                <div class="trainer-item style2">
                                    <div class="trainer-thumb"> <img src="<?= Yii::$app->request->baseUrl; ?>/images/team/4.jpg" alt="" class="img-fullwidth img-responsive"> </div>
    ...
    <!-- Section: Divider  -->
    <section class="divider parallax layer-overlay overlay-black" data-bg-img="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg7.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
                        <div class="pricing-table style2 pb-0 mt-sm-0 maxwidth400 bg-lightest">
                            <div class="thumb text-center p-0 mb-0"> <a href="#"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/pricing/1.jpg" alt=""></a> </div>
                            <div class="pl-40">
                    ...
                    <div class="col-xs-12 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
                        <div class="pricing-table style2 pb-0 mt-sm-0 maxwidth400 bg-lightest">
                            <div class="thumb text-center p-0 mb-0"> <a href="#"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/pricing/2.jpg" alt=""></a> </div>
                            <div class="pl-40">
                    ...
                    <div class="col-xs-12 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
                        <div class="pricing-table style2 pb-0 mt-sm-0 maxwidth400 bg-lightest">
                            <div class="thumb text-center p-0 mb-0"> <a href="#"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/pricing/3.jpg" alt=""></a> </div>
                            <div class="pl-40">
    ...
    <!-- Section: Clients -->
    <section class="divider parallax layer-overlay overlay-dark"  data-bg-img="<?= Yii::$app->request->baseUrl; ?>/images/bg/bg7.jpg" >
        <div class="container">
            <div class="section-content">
                <div class="row">
                    <div class="clients-logo carousel owl-carousel-6col">
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/1.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/2.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/3.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/4.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/5.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/6.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/2.jpg" alt=""></a> </div>
                        <div class="item"> <a href="#"><img src="<?= Yii::$app->request->baseUrl; ?>/images/clients/4.jpg" alt=""></a> </div>
                    </div>
                </div>
            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <article class="post clearfix mb-30">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/blog/1.jpg" alt=""> </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <article class="post clearfix mb-30">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/blog/2.jpg" alt=""> </div>
                                <div class="entry-content">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <article class="post clearfix mb-30">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img class="img-fullwidth" src="<?= Yii::$app->request->baseUrl; ?>/images/blog/3.jpg" alt=""> </div>
                                <div class="entry-content">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="contact-wrapper">
                            ...
                            <!-- Contact Form -->
                            <form id="contact_form" name="contact_form" class="form-transparent" action="http://kodesolution.com/demo/health-beauty/sports-trainer/v2.0/demo/includes/sendmail.php" method="post">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="col-sm-6">
